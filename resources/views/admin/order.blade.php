               ...
               <div class="inqbox">
                  <div class="inqbox-content">
                           ...
                           <div class="input-group">
                            ...
                            <button type="button" class="btn btn btn-primary" onclick="seach_code_order()"> <i class="fa fa-search"></i>Tìm kiếm</button>
                            </span>
                         </div>
...
<button style="width:50px;"></button>
    ...
    <meta name="csrf-token-seach-code" content="{{ csrf_token() }}" />
