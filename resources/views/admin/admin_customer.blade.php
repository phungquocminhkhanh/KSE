                  ...
                  <div class="inqbox-content">
                           ...
                           <div class="clients-list">
                              <ul class="nav nav-tabs tab-border-top-danger">
                                 <li class="active"><a data-toggle="tab" onclick="show_customer()"><i class="fa fa-user" ></i> Khách hàng</a></li>
                                 <li class="active"> <button type="button" name="x" id="x" data-toggle="modal" data-target="#add_customer_Modal" class="btn btn-warning">+</button></li>
                              </ul>
